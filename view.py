...
class App:
    def __init__(self,master):
        ...
        self.mybutton.place(x=180,y=50)
        ...
        self.mybutton1.place(x=180,y=140)
        ...
        self.mybutton2.place(x=180,y=230)
        self.mybutton2.config(height=3,width=30)

        self.mybutton3 =Button(master,text="Courier",command=self.courier,fg='white', bg='#308d46')
        ...
        self.mybutton4.place(x=180,y=410)
    ...
    def student_info(self):
        import viewstudent
        sys.modules.pop('viewstudent')

    def room_info(self):
        import viewroominfo
        sys.modules.pop('viewroominfo')
    
    def mess_info(self):
        import viewmess
        sys.modules.pop('viewmess')
