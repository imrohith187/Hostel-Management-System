...
class App:
    def __init__(self,master):
        ...
        #values
         ...
         #lables
        self.Rollno = Label(master, text = "Roomno",font = ("Arial", 11))
        self.Rollno.place(x = 25,y = 50)
        self.Rollno.config(bg="#28282B",fg="white")  

        self.Roomno = Label(master, text = "Block",font = ("Arial", 11))
        self.Roomno .place(x = 25, y = 100) 
        self.Roomno.config(bg="#28282B",fg="white") 

        self.block = Label(master, text = "Reason",font = ("Arial", 11))
        self.block.place(x = 25,y = 150)
        self.block.config(bg="#28282B",fg="white") 

        self.roomtype = Label(master, text = "Available Time",font = ("Arial", 11))
    ...
    def submit(self):
        ...
        sql = "INSERT INTO complaints (roomno,block,reason,availabletime) values(%s,%s,%s,%s)"
