...
class App:
    def __init__(self,master):
        ...
        self.Roomno = Label(master, text = "Bill Amount",font = ("Arial", 11))
        ...
        self.roomtype.place(x = 25,y = 220) 
    ...
    def submit(self):
        ...
        sql = "INSERT INTO mess (rollno,billamount,veg_nonveg,menutype) VALUES (%s, %s, %s, %s)"
        val = (self.e1.get(), self.e2.get(),a,b)
        c.execute(sql,val)
        mydb.commit()
        mydb.close() 
